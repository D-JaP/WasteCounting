...
class ContextualModule(nn.Module):
    ...
    def forward(self, feats):
        ...
        bottle = self.bottleneck(cat(overall_features, 1))
...
class CANNet2s_deeper (CANNet2s):
    def __init__(self, load_weights=True):
        super(CANNet2s_deeper, self).__init__()
        self.context = ContextualModule(512, 1024)
...
class CANNet2s_bottle (CANNet2s):
    pass
class CANNet2s_helmet (CANNet2s):
    pass
class CANNet2s_spray(CANNet2s_deeper):
    pass
class CANNet2s_ball(CANNet2s_deeper):
    pass
class CANNet2s_foam(CANNet2s_deeper):
    pass

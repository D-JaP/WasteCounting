...
for i in range(len(img_paths)):
    ...
    flow_10_path = os.path.join(output_folder+'/'+folder_name,base_name).replace('.jpg','_'+folder_name+'_flow_10.jpg')
    ...
    flow_10 = cv2.resize(prev_flow[9],(640,360),interpolation = cv2.INTER_CUBIC)/64.0
    ...
    plotDensity(flow_10,flow_10_path)
